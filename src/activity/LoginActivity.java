...
public class LoginActivity extends JFrame implements KeyListener {
    ...
    void init() {
        //初始化登录界面
        //设置窗口图标
        setIconImage(Toolkit.getDefaultToolkit().getImage("./src/pictures/login.png"));
        setTitle("登录"); //窗口标题
        setFont(new Font("黑体", Font.BOLD, 12));
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setBounds(550, 250, 1000, 600);  //窗口大小
        setResizable(false); //设置窗体大小 可变
    ...
    void handle_exit() {
        int n = JOptionPane.showConfirmDialog(this, "您确认要离开吗?", "退出确定", JOptionPane.YES_NO_OPTION);
